 ...
 * @type {string}
 */
var username = process.env.QB_USERNAME || "admin";
...
console.log("   QB_USERNAME from env:", process.env.QB_USERNAME);
console.log(
  "   QB_PASSWORD from env:",
  process.env.QB_PASSWORD ? "SET" : "NOT SET"
);
...
// Debug logging for company file
console.log("📁 Company file configuration:");
console.log("   QB_COMPANY_FILE from env:", process.env.QB_COMPANY_FILE);
console.log("   Final company file path:", companyFile);
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.authenticate = function (
  ...
  var receivedUsername = args.strUserName ? args.strUserName.trim() : "";
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.connectionError = function (
  ...
  if (args.hresult === "0x80040408") {
    ...
    console.log("   2. Open your company file in QuickBooks");
    console.log(
